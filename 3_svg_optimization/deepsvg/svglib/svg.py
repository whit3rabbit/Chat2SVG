...
class SVG:
    ...
    def from_str(svg_str: str):
        ...
        # if(viewBox_str and len(viewBox_str) > 0):
    ...
    def to_str(self, fill=False, with_points=False, with_handles=False, with_bboxes=False, with_markers=False,
        ...
        newline = "\n"
        return (
            f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="{self.viewbox.to_str()}" height="224" width="224">'
            # f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="{self.viewbox.to_str()}" height="512px" width="512px">'
